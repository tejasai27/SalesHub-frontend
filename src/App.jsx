...
function App() {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-white font-poppins overflow-hidden">
      ...
      {/* View Toggle Tabs - Below Header */}
      <div className="bg-white border-b border-slate-200 px-4 py-2 flex-shrink-0">
        <div className="flex bg-slate-100 rounded-lg p-1 w-fit">
          <button
            onClick={() => setActiveView("chat")}
            className={`flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium transition-all ${activeView === "chat"
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium transition-all ${activeView === "tracking"
              ? "bg-white text-indigo-600 shadow-sm"
              : "text-slate-600 hover:text-slate-800 hover:bg-slate-50"
              }`}
          >
